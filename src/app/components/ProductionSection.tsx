  ...
  const productionAreas = [
    {
      ...
      stats: [
        { label: 'Площадь', value: '4 000 м²' },
        { label: 'Макс. масса', value: '50 тонн' },
        { label: 'Макс. длина', value: '12 метров' },
      ],
    ...
    },
    {
      ...
      controls: [
        ...
        'Неразрушающий контроль (УЗК, РК, ВИК, МК)',
    ...
    },
    {
      ...
      stats: [
        { label: 'Давление', value: 'до 60 МПа' },
        { label: 'Температура', value: 'до 500°C' },
      ],

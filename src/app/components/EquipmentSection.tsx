...
export function EquipmentSection() {
  const equipment = [
    {
      ...
      params: 'Оголовки, средства контроля пламени и розжига',
      industries: 'Добыча, переработка и транспорт углеводородов',
    },
    {
      name: 'Емкостное оборудование',
      params: 'Аппараты и резервуары для технологических установок',
      industries: 'Нефтегазовая, химическая, энергетическая',
    },
    {
      name: 'Блочно-модульное оборудование',
      params: 'Комплектные технологические блоки заводской готовности',
      industries: 'Нефтегазовая инфраструктура и промышленные объекты',
    },
    {
      name: 'АСУТП',
      params: 'Автоматизированные системы управления технологическими процессами',
      industries: 'Производственные и технологические комплексы',
    },
    {
      name: 'Теплообменное оборудование',
      params: 'Аппараты теплообмена для промышленных установок',
      industries: 'Нефтепереработка, энергетика, химическая промышленность',
    },
    {
      name: 'Колонное оборудование',
      params: 'Колонны и аппараты для процессов разделения и очистки',
      industries: 'Нефтегазовая и химическая промышленность',
    },
    {
      name: 'Подогреватели высокого давления',
      params: 'Оборудование для тепловых электростанций',
      industries: 'Тепловая энергетика',
    },
    {
      name: 'Подогреватели низкого давления',
      params: 'Теплообменные аппараты для энергетических установок',
      industries: 'Тепловая энергетика',
    },
    {
      name: 'Подогреватели сетевой воды',
      params: 'Оборудование водоподготовки и теплоснабжения',
      industries: 'Энергогенерирующие компании',
    },
    {
      name: 'Котельное оборудование',
      params: 'Поверхности нагрева и элементы трубопроводов',
      industries: 'Тепловые и промышленные котельные',
    },
    {
      name: 'Клапаны',
      params: 'Регулирующие, запорные и запорно-регулирующие клапаны',
      industries: 'Технологические трубопроводы и установки',
    },
  ];
  ...
  const projects = [
    ...
    },
    {
      ...
      solution: 'Проектирование, расчет на прочность, изготовление из стали 09Г2С с учетом требований ТР ТС и системы менеджмента качества ISO 9001',
  ...
  const standards = [
    ...
    { name: 'ISO 9001', fullName: 'Система менеджмента качества', color: 'from-[#50626C] to-[#595B5C]' },
    { name: 'STO INTI S.QS.7', fullName: 'Отраслевая сертификация', color: 'from-[#8D9DA6] to-[#A7A9AC]' },
    { name: 'НАКС', fullName: 'Аттестация персонала и сварочных технологий', color: 'from-[#50626C] to-[#8D9DA6]' },
    { name: 'Лаборатория', fullName: 'Свидетельство аттестации лаборатории', color: 'from-[#595B5C] to-[#A7A9AC]' },
  ];
          ...
          >
            <div>
              ...
              <div className="space-y-3">
                {[
                  'Факельное, емкостное и блочно-модульное оборудование',
                  'Теплообменное и колонное оборудование',
                  'Котельное оборудование и элементы трубопроводов',
                  'Сертификация ТР ТС, ISO 9001, STO INTI S.QS.7',
                ].map((item, index) => (
                  <motion.div
                    key={index}

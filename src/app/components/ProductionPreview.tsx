...
const capabilities = [
  ...
  },
  {
    ...
    tags: ['Визуально-измерительный контроль', 'Радиография до 60 мм', 'Ультразвуковой контроль', 'Рентгенофлуоресцентный контроль', 'Контроль герметичности', 'Контроль проникающими веществами', 'Капиллярный контроль', 'Гидравлические / пневматические испытания'],
